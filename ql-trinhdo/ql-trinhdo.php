...
<head>
  ...
  <link rel="stylesheet" href="./trinhdo.css">
...
<body>
  <div class="header">
    ...
    <div class="header__navbar" id="menu-btn">
      ...
      <span class="navbar__title navbar__item">Danh mục <i class="fa-solid fa-chevron-right navbar__item"></i> <a
          href="#" class="link__page navbar__item">Quản lí trình độ</a></span>
    </div>
  </div>
  <div class="container">
    <div class="menu">
      <h2 class="menu__title">Danh sách trình độ</h2>
      <div class="btn__add" id="add">Thêm trình độ mới</div>
      <div class="search">
        <input type="text" class="search__input search__item" name="search" placeholder="Tên trình độ" id="">
    ...
    <div class="table__container">
      <table class="table">
        <tr class="table__header">
          ...
          <th class="header__title">Mã trình độ </th>
          <th class="header__title">Tên trình độ </th>
          <th class="header__title">Mô tả trình độ </th>
    ...
    <div class="popup__add-form" id="popup-add">
      ...
      <h3 class="form__title">Thêm trình độ mới</h3>
      <input type="text" name="maTD" placeholder="Mã trình độ" class="form__item">
      <input type="text" name="tenTD" placeholder="Tên trình độ" class="form__item">
      <input type="text" name="motaTD" placeholder="Mô tả trình độ" class="form__item">
      <div class="btn__add form__btn-add">Thêm trình độ</div>
    </div>
  </div>
  ...
  <script src="./ql-trinhdo.js"></script>
</body>
