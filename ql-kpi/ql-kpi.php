...
<body>
  ...
  <div class="container">
    <div class="menu">
      ...
      <div class="btn__add" id="add">Thêm KPI mới</div>
      <div class="search">
    ...
    <div class="popup__add-form" id="popup-add">
      ...
      <input type="text" name="maKPI" placeholder="Mã KPI" class="form__item">
      <input type="text" name="tenKPI" placeholder="Tên KPI" class="form__item">
      <input type="text" name="maNV" placeholder="Mã nhân viên" class="form__item">
      <input type="text" name="ngaybd" placeholder="Ngày bắt đầu" class="form__item">
      <input type="text" name="ngaykt" placeholder="Ngày kết thúc" class="form__item">
      <input type="text" name="muctieu" placeholder="Mục tiêu" class="form__item">
      <input type="text" name="tytrong" placeholder="Tỷ trọng" class="form__item">
      <div class="btn__add form__btn-add">Thêm KPI</div>
    </div>
  </div>
